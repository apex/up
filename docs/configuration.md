...
- `timeout` – Function timeout in seconds (Default `5`, Min `1`, Max `300`)
...
By default Up will serve a minimalistic error page for you, when the client accepts `text/html`.
