...
func bindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "bindata.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1504628316, 0)}
...
func shimGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "shim.go", size: 126, mode: os.FileMode(420), modTime: time.Unix(1504200638, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
