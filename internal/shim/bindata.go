...
func bindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "bindata.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1505243500, 0)}
...
func shimGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "shim.go", size: 137, mode: os.FileMode(420), modTime: time.Unix(1505167108, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
