...
func bindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "bindata.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1507548095, 0)}
...
func indexJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.js", size: 1955, mode: os.FileMode(420), modTime: time.Unix(1507548079, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
